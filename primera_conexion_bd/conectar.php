...
function conectarDB(){
	...
	// Nombre de host: 127.0.0.1, nombre de usuario: tu_usuario, contraseña: tu_contraseña, bd: programacion\_web
	$mysqli = new mysqli('127.0.0.1', 'programacionWeb', 'pw*987', 'programacionweb');
